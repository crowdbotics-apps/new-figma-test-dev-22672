...
## Project Structure
    ...
    ├── new_figma_test_dev_22672  # Django project configurations
...
1. Clone this repo and `cd new_figma_test_dev_22672`
...
2. Clone this repo and `cd new_figma_test_dev_22672`
